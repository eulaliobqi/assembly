...
for i, v in enumerate(vals):
    ax2.text(i, v + 60, f"{v:,} pb", ha="center", fontsize=9, fontweight="bold")
ax2.set_xticks(xpos)
...
ax3.set_title("C   Completude BUSCO: C:96,2% [S:39,9%,D:56,3%], F:1,9%, M:1,9%",
              loc="left", fontweight="bold", pad=8, fontsize=10)
...
ax4.text(0, 0, f"{N_PROTEINS:,}\nORFs", ha="center", va="center",
          fontsize=9.5, fontweight="bold", color="#333333", multialignment="center")
